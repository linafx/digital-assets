...
haskell_cabal_binary(
    ...
    """,
    sha256 = "eeddc1fb539131345def81218412fc65027d0ecb3b34cceef355c60948aa4599",
    strip_prefix = "ghcide-44b11667d8593ae84c48ca88e96f4f227deec096",
    urls = ["https://github.com/digital-asset/ghcide/archive/44b11667d8593ae84c48ca88e96f4f227deec096.tar.gz"],
)
...
haskell_library(
    ...
    patch_args = ["-p1"],
    patches = [
        "@com_github_digital_asset_daml//bazel_tools:ghcide-ghc-lib.patch",
    ],
    sha256 = "eeddc1fb539131345def81218412fc65027d0ecb3b34cceef355c60948aa4599",
    strip_prefix = "ghcide-44b11667d8593ae84c48ca88e96f4f227deec096",
    urls = ["https://github.com/digital-asset/ghcide/archive/44b11667d8593ae84c48ca88e96f4f227deec096.tar.gz"],
