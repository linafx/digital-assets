...
object Queries {
  ...
  val indexContractsTable: Fragment = sql"""
      CREATE INDEX poop ON contract (tpid)
    """
  ...
  val createOffsetTable: Fragment = sql"""
      CREATE TABLE
        ...
        (party NVARCHAR2(100) NOT NULL
        ,tpid NUMBER NOT NULL REFERENCES template_id (tpid)
        ,last_offset NVARCHAR2(100) NOT NULL
  ...
  val createTemplateIdsTable: Fragment = sql"""
      CREATE TABLE
        template_id
        (tpid NUMBER GENERATED by default on null as IDENTITY NOT NULL PRIMARY KEY
        ,package_id NVARCHAR2(100) NOT NULL
        ,template_module_name NVARCHAR2(100) NOT NULL
        ,template_entity_name NVARCHAR2(100) NOT NULL
