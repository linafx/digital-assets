...
object Config {
  ...
  def createDefault[Extra](extra: Extra): Config[Extra] =
    Config(
      ...
      stateValueCache = caching.WeightedCache.Configuration(256L * 1024L * 1024L),
      lfValueTranslationEventCache = caching.SizedCache.Configuration(64L * 1024L),
      lfValueTranslationContractCache = caching.SizedCache.Configuration(64L * 1024L),
